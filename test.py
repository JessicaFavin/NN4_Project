...
6. Change the distribution of the examples in the following way: 60% in the learning base andthe rest in the test base. Optimize the structure of the neural network (number of cells inhidden layer);
